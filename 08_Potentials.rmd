...
```{r agfig, echo=FALSE, fig.align='center', fig.cap='Behavior of Helmholtz (red) and Gibbs (blue) Free Energies for Spontaneous Transformations at Constant T,V (left) and Constant T,P (right)'}
x <- seq(0,1.25,0.01)
i <- 0.2
f <- 1
p1 <- 0.5
