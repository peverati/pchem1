...
## Chapter Review {#rev15}

### Practice Problems {#exer15}

**Problem 1: Determining Reaction Order from Initial Rates**
...
**Solution:** To determine the reaction orders, compare rates between experiments:
...
**Answer:** The rate law is: Rate = $k[A]^2[B]$. The reaction is second order in $A$, first order in $B$, with an overall order of 3.

---

**Problem 2: Calculating Half-Life for a First-Order Reaction**

Calculate the half-life of a first-order reaction with rate constant $k = 0.0231\,\text{s}^{-1}$.

**Solution:** For a first-order reaction, the half-life is given by eq. \@ref(eq:kin8) as:
...
**Answer:** The half-life of the reaction is $30.0\,\text{s}$.

---

**Problem 3: Determining Activation Energy Using the Arrhenius Equation**
...
**Solution:** We can use the Arrhenius equation in its linearized form, eq. \@ref(eq:Arr2):
...
**Answer:** The activation energy is $32.3\,\text{kJ/mol}$.

---

**Problem 4: Calculating Concentration in a Second-Order Reaction**
...
**Solution:** For a second-order reaction, the integrated rate law is given by eq. \@ref(eq:kin11), which for our case is:
...
**Answer:** The concentration of $\text{Cl}$ after $100\,\text{s}$ is $0.024\,\text{M}$.

---

**Problem 5: Determining Rate Constant for a Zero-Order Reaction**
...
**Solution:** For a zero-order reaction, the integrated rate law is given by \@ref(eq:kin3):
...
**Answer:** The rate constant for the zero-order reaction is $0.001\,\text{M}\text{s}^{-1}$.


### Study Questions {#quest15}

**1. Which of the following is true for a zeroth-order reaction?**

a. The reaction rate is independent of reactant concentration.
b. The reaction rate is directly proportional to reactant concentration.
c. The reaction rate is proportional to the square of reactant concentration.
d. The reaction rate decreases exponentially with time.
e. The reaction rate increases logarithmically with reactant concentration.

---

**2. What are the units of the rate constant for a second-order reaction?**
...
**3.In the Arrhenius equation, $k = A\exp(-\frac{E_a}{RT})$, what does $E_a$ represent?**
...
**4. For a first-order reaction, how is the half-life related to the rate constant $k$?**

a. $t_{1/2} = \frac{\ln 2}{k}$.
b. $t_{1/2} = \frac{k}{\ln 2}$.
c. $t_{1/2} = \frac{1}{k}$.
d. $t_{1/2} = \frac{k}{2}$.
e. $t_{1/2} = 2k$.
...
**5. Which method is used to determine reaction orders by using large excess concentrations of all reactants but one?**

a. Isolation method.
b. Initial rates method.
c. Half-life method.
d. Integrated rate law method.
e. Arrhenius method.

---

**6. What is the overall reaction order for a reaction with rate law $\text{Rate} = k[A][B]^2$?**
...
**7. In a consecutive reaction $A \xrightarrow{k_1} B \xrightarrow{k_2} C$, what condition leads to a rate-determining step in the middle of the sequence?**
...
**8. What is the relationship between the equilibrium constant $K_C$ and the forward and reverse rate constants $k_1$ and $k_{-1}$ for an opposed reaction at equilibrium?**
...
**9. Which of the following plots would give a straight line for a second-order reaction?**
...
**10. What is the maximum experimentally observed reaction order for elementary reactions?**
