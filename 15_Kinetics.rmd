...
|                        | $[\mathrm{A}]_0 \; (\text{M})$ | $[\mathrm{A}]_0 \; (\text{M})$ | $\text{initial rate}\;\left(\frac{M}{s}\right)$ |
| :--------------------- | :----------------------------: | :----------------------------: | :---------------------------------------------: |
...
From empirical arguments, Arrhenius proposed the idea that reactants must acquire a minimum amount of energy before they can form  any product. He called this amount of minimum energy the activation energy. We can motivate this assumption by plotting energy of a reaction along the reaction coordinate, as in Figure \@ref(fig:figk9).^[This plot is taken from [Wikipedia](https://en.wikipedia.org/wiki/Transition_state_theory) and distributed under CC-BY-SA license.] The reaction coordinate is defined as the minimum  energy path that connects the reactants with the products.
