...
a. $K_P = K_y \cdot \left(\frac{P^{\standardstate}}{P}\right)^{\Delta \nu}$
b. $K_P = K_y \cdot \left(\frac{P}{P^{\standardstate}}\right)^{\Delta \nu}$
