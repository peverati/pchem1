...
**Problem 1:** Determine the enthalpy change, $\Delta_{\text{rxn}} H^\standardstate$, when 1 mole of $\text{N}_2 \text{O}_{4\text{(g)}}$ dissociates into 2 moles of $\text{NO}_{2\text{(g)}}$ at constant standard pressure. Use the standard enthalpy of formation tables at the end of the book to fetch the data that you need.
...
**Problem 2:** Determine the enthalpy change $\Delta_{\text{rxn}} H^\standardstate$ when 1 mole of $\text{SO}_{2\text{(g)}}$ is oxidized to $\text{SO}_{3\text{(g)}}$ at constant standard pressure. Use the standard enthalpy of formation tables at the end of the book to fetch the data that you need.
