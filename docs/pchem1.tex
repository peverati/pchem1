...
\hypertarget{differential-and-integrated-rate-laws}{%
\section{Differential and integrated rate laws}\label{differential-and-integrated-rate-laws}}
...
\item
  ...
  \label{eq:kin14}
  \end{equation}
  The differential equation in eq. \eqref{eq:kin14} has two variables, and cannot be solved exactly unless an additional relationship is specified. If we assume that the initial concentration of the two reactants are equal, then \([\mathrm{A}]=[\mathrm{B}]\) at any time \(t\), and eq. \eqref{eq:kin14} reduces to eq. \eqref{eq:kin9}. If the concentration of the reactants are different, then the integrated rate law will assume the following shape:
  \begin{equation}
...
\hypertarget{complex-laws}{%
\section{Complex Laws}\label{complex-laws}}
...
\hypertarget{experimental-methods-for-determination-of-reaction-order}{%
\section{Experimental Methods for Determination of Reaction Order}\label{experimental-methods-for-determination-of-reaction-order}}

\hypertarget{arrhenius-equation}{%
\section{Arrhenius Equation}\label{arrhenius-equation}}
