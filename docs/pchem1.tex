...
\addcontentsline{toc}{section}{Author's Note to the August 2024 Edition.}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.5312}}@{}}
\toprule\noalign{}
...
\(T_B = 78.35^\circ\text{C}+273.15=351.51\,\text{K}\).
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2872}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1277}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3404}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2447}}@{}}
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1720}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1720}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4459}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
...
\tightlist
\item
  \(K_P = K_y \cdot \left(\frac{P^{{-\kern-6pt{\ominus}\kern-6pt-}}}{P}\right)^{\Delta \nu}\)
\item
  \(K_P = K_y \cdot \left(\frac{P}{P^{{-\kern-6pt{\ominus}\kern-6pt-}}}\right)^{\Delta \nu}\)
\item
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1414}}
...
Answers: 1.b, 2.a, 3.c, 4.c, 5.b, 6.b, 7.d, 8.a, 9.a, 10.b
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1731}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1474}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1891}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4038}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\emph{Zeroth-Order}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2326}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2326}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3643}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\([\mathrm{A}]_0 \; (\text{M})\)
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2216}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2273}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2102}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2102}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Substance:
...
F\textsuperscript{--}(aq) & --335.4 & --278.8 & \multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4205} + 2\tabcolsep}@{}}{%
--13.8 \textbar{} \textbar{}} \\
...
Fe\textsuperscript{2+}(aq) & --89.1 & --78.9 & \multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4205} + 2\tabcolsep}@{}}{%
--137.7 \textbar{} \textbar{}} \\
Fe\textsubscript{2}O\textsubscript{3}(s) & --824.2 & --742.2 & 87.4 & 103.9 \\
Fe\textsuperscript{3+}(aq) & --48.5 & --4.7 & \multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4205} + 2\tabcolsep}@{}}{%
--315.9 \textbar{} \textbar{}} \\
...
HF(aq) & --332.6 & --278.8 & \multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4205} + 2\tabcolsep}@{}}{%
--13.8 \textbar{} \textbar{}} \\
...
OH\textsuperscript{--}(aq) & --230.0 & --157.2 & \multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4205} + 2\tabcolsep}@{}}{%
--10.9 \textbar{} \textbar{}} \\
