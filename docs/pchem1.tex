...
\hypertarget{w_textmax-and-w_textmin-in-isothermal-processes}{%
\subsection{\texorpdfstring{\(| W_{\text{max}} |\) and \(| W_{\text{min}} |\) in isothermal processes}{\textbar{} W\_\{\textbackslash text\{max\}\} \textbar{} and \textbar{} W\_\{\textbackslash text\{min\}\} \textbar{} in isothermal processes}}\label{w_textmax-and-w_textmin-in-isothermal-processes}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2312}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2139}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2139}}@{}}
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
Substance:
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.0837}}
