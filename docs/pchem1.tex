...
\chapter{Instroduction to Thermodynamics}\label{SystemVariables}}
...
\textbf{1. What is a thermodynamic system?}

\begin{enumerate}
\def\labelenumi{\alph{enumi}.}
\tightlist
\item
  A portion of space with defined boundaries separating it from its surroundings.
\item
  Any physical object in the universe.
\item
  A portion of space with real physical barriers.
\item
  A portion of space that is completely isolated form everything else.
\item
...
\textbf{2. Which type of system exchanges only energy but not mass with its surroundings?}
...
\textbf{3. According to the chemistry convention of signs, what sign is assigned to mass entering a system?}
...
\textbf{4. What is an example of an intensive variable?}
...
\textbf{5. Which of the following variables is NOT part of the ideal gas law?}
...
\textbf{7. Which of the following is a state function?}
...
\textbf{8. What happens to the variables of a system when it absorbs energy?}
...
\item
  One or more of its variables (such as temperature) increase.
\item
  The system becomes isolated.
\item
  The system's pressure decreases.
\item
  The system's volume becomes infinite.
\end{enumerate}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\textbf{9. Which of the following is an extensive variable?}
...
\textbf{10. What is the term for variables that depend only on the current state of the system and define it?}
...
\textbf{Problem 1:} Determine the enthalpy change, \(\Delta_{\text{rxn}} H^{-\kern-6pt{\ominus}\kern-6pt-}\), when 1 mole of \(\text{N}_2 \text{O}_{4\text{(g)}}\) dissociates into 2 moles of \(\text{NO}_{2\text{(g)}}\) at constant standard pressure. Use the standard enthalpy of formation tables at the end of the book to fetch the data that you need.
...
\textbf{Problem 2:} Determine the enthalpy change \(\Delta_{\text{rxn}} H^{-\kern-6pt{\ominus}\kern-6pt-}\) when 1 mole of \(\text{SO}_{2\text{(g)}}\) is oxidized to \(\text{SO}_{3\text{(g)}}\) at constant standard pressure. Use the standard enthalpy of formation tables at the end of the book to fetch the data that you need.
...
\def\labelenumi{\alph{enumi}.}
\item
  \(nR(T_h - T_l)\ln\frac{V_B}{V_A}\).
\item
  \(nRT_h\ln\frac{V_B}{V_A}\).
\item
  \(-nR(T_h - T_l)\ln\frac{V_B}{V_A}\).
\item
  \begin{enumerate}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.17}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.17}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.45}}@{}}
\toprule
...
\[1.8 = K_y \cdot \left(\frac{1\,\text{bar}}{1\,\text{bar}}\right)^1,\]

\(K_y = 1.8\) at \(1\,\text{bar}.\)
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.50}}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.23}}
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.23}}
