...
Raoult's law applied to a system containing only one volatile component describes a line in the \(P,x_{\text{B}}\) plot, as in Figure \ref{fig:FigMC1}.
...
\begin{equation}
P_{\text{B}}=k_{\text{AB}} P_i^* x_{\text{B}},
\label{eq:mc1}
\end{equation}
...
{\centering \includegraphics[width=0.6\linewidth]{./img/OEP_Figures.025} 

}

\caption{The Pressure–Composition Phase Diagram of a Non-Ideal Solution Containing a Single Volatile Component at Constant Temperature.}\label{fig:FigMC7}
\end{figure}
