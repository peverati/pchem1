...
which results in the familiar $PV$ plots of Figure XXX. As we already discussed in chapter \@ref(ZerothLaw), each of the curves in Figure XXX is obtained at constant temperature, and it is therefore called *"isotherm."*
...
which results in the plots of figure XXX. Each of the curves is obtained at constant pressure, and it is termed *"isobar."*
...
which results in the plots of figure XXX. Each of the curves is obtained at constant volume, and it is termed *"isochor."*
...
Non-ideal gases (sometimes also referred to as "real gases"), do not behave as ideal gases because one or more of the assumptions in XXX are violated. To study how their behavior differs from an ideal gas we can use either a $P$ *vs.* $V$ diagram, or a $PV$ *vs.* $P$  diagram:

### The van der Waals equation
What characterizes non-ideal gases is that there is no unique equation that we can use to describe their behavior. For this reason, we have a plethora of several experimental equations, none of which is superior to the other. The simplest of such empirical equations was obtained in 1873 by Johannes Diderik van der Waals (1837–1923). The van der Waals (vdW) equation is the only one that we will analyze in detail because of its simple interpretation. However, it is far from universal, and for several non-ideal gases, it is severely inaccurate. Other popular non-ideal gases equations are the Clausius equation, the virial equation, the Redlich–Kwong model and several others.^[For more information on empirical equations for non-ideal gases see [this Wikipedia page](https://en.wikipedia.org/wiki/Real_gas).]
