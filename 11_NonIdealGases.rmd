...
which results in the familiar $PV$ plots of Figure \@ref(gig:FigPVideal). As we already discussed in chapter \@ref(ZerothLaw), each of the curves in Figure \@ref(gig:FigPVideal) is obtained at constant temperature, and it is therefore called *"isotherm."*
