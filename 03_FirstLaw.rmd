...
where the symbol $\oint$ indicates an integral along a cycle. However, the same is not valid for work. For instance, if we perform the expansion in one step, the work associated with it will be (using eq. \@ref(eq:WintF)):^[notice that the work for the expansion is negative, as it should be.]
